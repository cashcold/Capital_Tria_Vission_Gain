...
async function queryFebruaryData() {
  try {
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/yourdb');
    
    const userId = '6968b04f2af7721869ffee5c';
    const start = new Date(Date.UTC(2026, 1, 1, 0, 0, 0)); // February 1, 2026
    const end = new Date(Date.UTC(2026, 2, 1, 0, 0, 0));   // March 1, 2026
    ...
    console.log('=== FEBRUARY 2026 DATA FOR USER BOB45 ===\n');
